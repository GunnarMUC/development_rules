...
**Important**: Always consult `.github/copilot-instructions.md`, `playbook_new.md`, and `playbook.md` on every task. These files contain the persistent development principles that should be followed even if conversation context is lost.
